...
<div class="content-wrapper">
    ...
    @include('admin.partials.head', ['mainPangeName' => 'لینک ها', 'pageName' => 'افزودن لینک مرتبط'])
    <!-- Main content -->
      ...
      <div class="row">
        ...
        <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">افزودن لینک مرتبط</h3>
              </div>
              <!-- /.card-header -->
              <form action="{{ route('admin.related.link.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
