...
<div class="content-wrapper">
    ...
    @include('admin.partials.head', ['mainPangeName' => 'لینک ها', 'pageName' => 'ویرایش لینک'])
    <!-- Main content -->
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label>لینک</label>
                                <input type="text" name="external_link" class="form-control" value="{{ $link->external_link }}">
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <img id="blah" class="mt-2" src="{{ asset('uploads/links/'.$link->image) }}" alt="your image" width="120px"/>
                            </div>
