...
<div class="content-wrapper">
    ...
    @include('admin.partials.head', ['mainPangeName' => 'اخبار', 'pageName' => 'ویرایش خبر'])
    <!-- Main content -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <img id="blah" class="mt-2" src="{{ asset('uploads/news/'.$news->image) }}" alt="your image" width="100px"/>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <label class="ml-5"><input type="radio" {{ ($news->status == 1) ? 'checked' : '' }} 
                                       name="status" class="minimal" value="1">
                                    <span class="text-success">منتشر شود</span>
                                </label>
                                <label><input type="radio" {{ ($news->status == 0) ? 'checked' : '' }}
                                              name="status" class="minimal" value="0">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="checkbox" {{ ($news->special == 1) ? 'checked' : '' }}
                                       name="special" class="flat-red ml-2">ویژه
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label>توضیحات</label>
                                <textarea name="description" id="kt_docs_tinymce_hidden" 
                                class="ckeditor form-control">{{ $news->description }}</textarea>
                            </div>
