        ...
        <div class="row">
            <div class="col-md-8 pl-md-4">
                <p><span class="IRANSansWeb_Medium  text-lightgreen"><i
                            class="fas fa-2x fa-map-marker-alt ml-2"></i>آدرس :</span> خیابان جمهوری - کوچه بهارستان - پلاک 128 </p>
                <p><span class="IRANSansWeb_Medium  text-lightgreen"><i class="fas fa-2x fa-phone ml-2"></i>تلفن :
                    </span>09305733699</p>
                <p><span class="IRANSansWeb_Medium  text-lightgreen"><i
                            class="fas fa-2x fa-paper-plane ml-2"></i>ایمیل : </span>Info@gmail.com</p>
